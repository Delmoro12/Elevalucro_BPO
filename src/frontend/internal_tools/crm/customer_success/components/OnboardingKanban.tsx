    ...
    >
      <div className="space-y-3">
        ...
        <div className="flex items-start justify-between">
          ...
          <div className="text-right">
            <div className="text-sm font-medium text-emerald-600">
              R$ {client.valor_mensal.toLocaleString()}
            </div>
        ...
        <div className="bg-slate-50 dark:bg-slate-700/50 rounded-lg p-2">
          <div className="text-xs font-medium text-slate-600 dark:text-slate-400 mb-1">Próxima ação:</div>
          <div className="text-xs text-slate-700 dark:text-slate-300">{client.proxima_acao}</div>
        </div>
      ...
      <div className="mb-4 pb-3 border-b border-slate-200 dark:border-slate-700">
        ...
        {totalValue > 0 && (
          <div className="mt-2 text-sm text-emerald-600 font-medium">
            R$ {totalValue.toLocaleString()}/mês
          </div>
        )}
      </div>
