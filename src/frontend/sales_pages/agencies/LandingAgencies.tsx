...
import { CheckCircle, Clock, Shield, TrendingUp, Users, FileText, BarChart3, Megaphone, ArrowRight, Star, LineChart, Workflow, Smartphone, CreditCard, Banknote, Wallet, ShieldCheck, X, Building, Phone, Mail, UserCircle, Target, Calendar } from "lucide-react";
        ...
        <div className="text-center">
          <div className="bg-gradient-to-r from-emerald-500/10 to-emerald-400/5 rounded-3xl p-12 border border-emerald-500/20">
            ...
            <p className="text-xl text-slate-300 mb-8 max-w-3xl mx-auto">
              ...
              para transformar a gestão financeira da sua agência rapidamente.
            </p>
