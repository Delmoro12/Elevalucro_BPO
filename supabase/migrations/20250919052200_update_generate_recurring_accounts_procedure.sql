-- Migration: Update generate_recurring_accounts procedure for financial_transactions table
-- Description: Adapta procedure para usar financial_transactions ao invés de accounts_payable

-- ======================================
-- Function: Generate Recurring Financial Transactions
-- ======================================
-- Esta função gera transações recorrentes ou parceladas baseadas na configuração
    ...
    CASE p_occurrence_type
        WHEN 'weekly' THEN
            ...
            FOR v_i IN 1..v_installment_count LOOP
                ...
                ) RETURNING id, due_date, installment_number;
