-- ======================================
-- View: Accounts Payable Dashboard
-- ======================================
-- View completa para contas a pagar com dados enriquecidos
...
COMMENT ON VIEW accounts_payable_view IS 'View completa das contas a pagar com dados enriquecidos de fornecedores, categorias e status calculados';
...
-- Os índices já existem na tabela principal, mas a view se beneficia deles automaticamente