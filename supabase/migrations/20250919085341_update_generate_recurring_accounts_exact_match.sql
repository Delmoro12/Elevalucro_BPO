-- Migration: Update generate_recurring_accounts procedure - FINAL VERSION
-- Description: Versão corrigida da procedure que cria contas recorrentes sem ambiguidade no RETURNING
