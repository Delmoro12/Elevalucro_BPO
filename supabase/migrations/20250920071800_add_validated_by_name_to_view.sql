-- =============================================
-- Migration: Add validated_by_name field to financial_transactions_view
-- =============================================

-- Dropar e recriar a view principal adicionando o campo validated_by_name
...
SELECT 
    ...
    -- Nome do usuário que validou (NOVO CAMPO)
...
-- Recriar views dependentes que foram dropadas
