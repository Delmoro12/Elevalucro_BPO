-- ======================================
-- Migration: Create Cash Flow Indicators View
-- Data: 2025-09-20
-- Descrição: Cria views para indicadores e métricas de fluxo de caixa
-- ======================================
...
DO $$
BEGIN
    RAISE NOTICE 'Migration completed: Created cash_flow_indicators_view and cash_flow_summary_view';
END $$;