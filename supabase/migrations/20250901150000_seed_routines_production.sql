-- Temporary migration to seed routines in production
-- Will be applied and then we can remove this file
...
ON CONFLICT (name) DO NOTHING; -- Evita duplicatas se já existir