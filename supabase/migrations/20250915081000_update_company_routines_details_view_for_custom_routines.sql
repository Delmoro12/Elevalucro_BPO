-- =============================================================================
-- Migration: Update Company Routines Details View for Custom Routines
-- Generated at: 2025-09-15 08:10:00
-- =============================================================================
-- Atualiza a view company_routines_details para suportar rotinas customizadas
-- que não possuem routine_id (template).
--
-- Mudanças:
...
--
-- Isso permite que rotinas customizadas apareçam no frontend.
