-- ======================================
-- Migration: Add BPO operator signup function
-- Date: 2025-09-02
-- Description: Creates function for BPO operator registration
-- ======================================
...
GRANT EXECUTE ON FUNCTION create_bpo_operator_signup TO service_role;

-- Comment on function
COMMENT ON FUNCTION create_bpo_operator_signup IS 'Creates a BPO operator user record. Only creates user with bpo_side role, does not create company.';