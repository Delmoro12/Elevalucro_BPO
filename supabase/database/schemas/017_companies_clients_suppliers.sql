-- ======================================
-- 17. Companies Clients/Suppliers
-- ======================================
-- Tabela para cadastro de clientes e fornecedores das empresas
...
-- Unique constraints
-- Um cliente/fornecedor não pode ter o mesmo CNPJ para a mesma empresa
...
-- Um cliente/fornecedor não pode ter o mesmo CPF para a mesma empresa
